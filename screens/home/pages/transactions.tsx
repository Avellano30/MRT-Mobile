                ...
                <ScrollView scrollEnabled={true}>
                    ...
                    <Card style={{ marginHorizontal: 10, backgroundColor: 'white', marginVertical: 15 }}>
                        <Card.Content>
                            ...
                            <Text style={{ fontSize: 12 }}>Transactions as of {formattedDate(card?.transactions[card.transactions.length - 1].tapOut?.date ?? new Date().toISOString())}</Text>
                        </Card.Content>
                    </Card>

                    {card?.transactions.reverse().map((transaction, index) => (
                        <Card key={index} style={{ marginHorizontal: 10, backgroundColor: 'white', marginVertical: 3 }}>
                            <Card.Content style={{ marginLeft: 5, marginVertical: 1 }}>
                                ...
                                <View key={index} style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginTop: 5 }}>
